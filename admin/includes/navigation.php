...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="../index.php"><i class="fa fa-fw fa-home"></i> Visit Site</a>
                </li>
                <li>
                    ...
                    <ul id="postsDropdown" class="collapse">
                        <li>
                            <a href="#"><i class="fa fa-fw fa-eye"></i> View All Posts</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="bootstrap-grid.html"><i class="fa fa-fw fa-list-alt"></i> Categories</a>
                </li>
                ...
                <li>
                    <a href="bootstrap-elements.html"><i class="fa fa-fw fa-users"></i> Users</a>
                </li>
                <li>
